...
from .views import CreateOrganizationalWorkspaceView, ListUserWorkspacesView, TeamListCreateView,UpdateWorkspaceMemberRoleView,TeamDetailView,AddTeamMemberView,TeamPerformanceView
...
urlpatterns = [
    ...
    path('<int:workspace_id>/teams/<int:team_id>/performance/', TeamPerformanceView.as_view(), name='team-performance'),
]